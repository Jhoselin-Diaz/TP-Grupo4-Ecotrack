    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/huellas/calcular/**").hasAuthority("ADMIN")
                        .requestMatchers("/huellas/lista").hasAuthority("ADMIN")
                        .requestMatchers("/resultados/resultado/generar/**").hasAuthority("ADMIN")
                        .requestMatchers("/resultados/resultado/usuario/**").hasAuthority("ADMIN")
                        .requestMatchers("/detalles/obtener").hasAuthority("ADMIN")
                        .requestMatchers("/detalles/obtenerResultados/**").hasAuthority("ADMIN")
                        .requestMatchers("/equivalencias/obtener").hasAuthority("ADMIN")
                        .requestMatchers("/equivalencias/resultado/**").hasAuthority("ADMIN")
