    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/coches/total").hasAuthority("USER")
                        ...
                        .requestMatchers("/servicios/registrar").hasAuthority("USER")
                        .requestMatchers("/servicios/actualizar/**").hasAuthority("USER")
                        .requestMatchers("/servicios/MisServicio").hasAuthority("USER")
                        .requestMatchers("/servicios/elimina/**").hasAuthority("USER")
